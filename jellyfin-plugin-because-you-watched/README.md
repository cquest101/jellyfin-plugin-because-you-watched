...
- [Home Screen Sections](https://github.com/IAmParadox27/jellyfin-plugin-home-sections) by IAmParadox27. That plugin provides the home-screen rail; this plugin provides the brain that fills it. Install it first.

## Install

1. In Jellyfin, go to **Dashboard → Plugins → Repositories** and add this repository manifest URL:

   ```
   https://raw.githubusercontent.com/__OWNER__/jellyfin-plugin-because-you-watched/main/manifest.json
   ```

2. Go to **Catalog**, find **Because You Watched**, and install it.
3. Restart Jellyfin.
4. Make sure **Home Screen Sections** is installed and its modular home screen is enabled, then add the **Because You Watched** section to your home layout.

Or grab the zip from [Releases](../../releases) and drop it in your Jellyfin `plugins` folder.
